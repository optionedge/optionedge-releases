...
[![Windows Installer](https://img.shields.io/badge/Download-Windows%20Installer-blue)](https://store-api.optionedge.in/releases/OptionEdge_Installer_1.0.22.exe) 
...
[![Run on Google Cloud](https://gstatic.com/cloudssh/images/open-btn.svg)](https://console.cloud.google.com/cloudshell/open?cloudshell_git_repo=https://github.com/optionedge/optionedge-releases&cloudshell_working_dir=/&cloudshell_print=./deploy_google_cloud.sh; chmod +x deploy_google_cloud.sh; ./deploy_google_cloud.sh)
